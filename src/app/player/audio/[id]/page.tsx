...
const AudioPlayerPage = ( {params}: {params: {id: string}} ) => {
    return (
        <AppLayout>
            <div className="w-full h-auto flex max-lg:flex-col justify-between items-center gap-5 px-5 max-lg:py-2 py-9">
                ...
                <div className="max-md:w-full max-lg:w-10/12 w-6/12 max-xl:mr-0 mr-10 pb-10 flex flex-col justify-between gap-6">
                    <h1 className="text-fontPrimary font-bold text-4xl max-lg:text-2xl max-lg:text-center ">Queue</h1>
                    <PlayerQueue />
                </div>
            </div>
        </AppLayout>
