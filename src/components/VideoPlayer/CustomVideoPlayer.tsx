...
// import videoFile from "../../../public/assets/video/video.mp4";
        ...
        <>
            <div className="relative w-full">
                ...
                {settingsMenu ? (
                    ...
                    >
                    {/* <div
                        className={`absolute bg-slate-900 border border-bg-slate-300 outline-none text-white p-4 bottom-10 right-14 rounded-xl flex items-center gap-2 cursor-pointer`}
                    >
                        <h1>DarkMode</h1>
                        <RiCheckboxCircleLine />
                    </div> */}
