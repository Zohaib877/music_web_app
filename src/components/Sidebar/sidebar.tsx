  ...
  return (
    <>
      {/* Large Sidebar Start */}
        ...
        >
            ...
            <ul className="list-none flex-1 flex flex-col justify-start items-start py-5">
                <li className="flex items-center my-5 group w-full hover:cursor-pointer">
                    <Link href="/" className="flex flex-row items-center w-full" onClick={() => dispatch(closeSidebar())}>
                        <Image
                            src="/assets/icons/home_icon.png"
                            alt="home"
                            width={35}
                            height={35}
                            className={`group-hover:filter-custom-filter ${isActive("/") ? "filter-custom-filter" : "" }`}
                        />
                        <p
                            className={`font-medium text-xl text-fontPrimary ${
                            isOpen ? "pl-7" : "hidden"
                            } group-hover:filter-custom-filter ${isActive("/") ? "filter-custom-filter" : "" }`}
                        >
                            HOME
                        </p>
                    </Link>
                ...
                <li className="flex items-center my-5 group w-full hover:cursor-pointer">
                    <Link href="/my-library" className="flex flex-row items-center w-full"  onClick={() => dispatch(closeSidebar())}>
                        <Image
                            src="/assets/icons/library_icon.png"
                            alt="library"
                            width={35}
                            height={35}
                            className={`group-hover:filter-custom-filter ${isActive("/my-library") ? "filter-custom-filter" : "" }`}
                        />
                        <p
                            className={`font-medium text-xl text-fontPrimary ${
                            isOpen ? "pl-7" : "hidden"
                            } group-hover:filter-custom-filter ${isActive("/my-library") ? "filter-custom-filter" : "" }`}
                        >
                            My Library
                        </p>
                    </Link>
                ...
                <li className="flex items-center my-5 group w-full hover:cursor-pointer">
                    <Link href="/language" className="flex flex-row items-center w-full"  onClick={() => dispatch(closeSidebar())}>
                        <Image
                            src="/assets/icons/language_icon.png"
                            alt="language"
                            width={35}
                            height={35}
                            className={`group-hover:filter-custom-filter ${isActive("/language") ? "filter-custom-filter" : "" }`}
                        />
                        <p
                            className={`font-medium text-xl text-fontPrimary ${
                            isOpen ? "pl-7" : "hidden"
                            } group-hover:filter-custom-filter ${isActive("/language") ? "filter-custom-filter" : "" }`}
                        >
                            Language
                        </p>
                    </Link>
                ...
                <li className="flex items-center my-5 group w-full hover:cursor-pointer">
                    <Link href="/artists" className="flex flex-row items-center w-full"  onClick={() => dispatch(closeSidebar())}>
                        <Image
                            src="/assets/icons/artist_icon.png"
                            alt="artists"
                            width={35}
                            height={35}
                            className={`group-hover:filter-custom-filter ${isActive("/artists") ? "filter-custom-filter" : "" }`}
                        />
                        <p
                            className={`font-medium text-xl text-fontPrimary ${
                            isOpen ? "pl-7" : "hidden"
                            } group-hover:filter-custom-filter ${isActive("/artists") ? "filter-custom-filter" : "" }`}
                        >
                            Artists
                        </p>
                    </Link>
                ...
                <li className="flex items-center my-5 group w-full hover:cursor-pointer">
                    <Link href="#" className="flex flex-row items-center w-full" onClick={() => dispatch(openSearchModel())}>
                    <Image
        ...
        {/* Small Sidebar Start */}
        <div className={`lg:hidden xl:hidden flex flex-col justify-between z-10 fixed top-0 ${ isOpen ? "w-72 px-6" : "w-0 overflow-hidden" } h-screen bg-sideBarBackground transition-all duration-300 py-5`}>
            <div>
                {isOpen ? (
                    <Image
                        className="cursor-pointer"
                ...
                <ul className="list-none flex-1 flex flex-col justify-start items-start py-2">
                    ...
                    <li className="flex items-center my-3 group w-full hover:cursor-pointer">
                        <Link href="/my-library" className="flex flex-row items-center w-full">
                            <Image
                                src="/assets/icons/library_icon.png"
                                alt="library"
                                width={20}
                    ...
                    <li className="flex items-center my-3 group w-full hover:cursor-pointer">
                        <Link href="/language" className="flex flex-row items-center w-full">
                            <Image
                                src="/assets/icons/language_icon.png"
                                alt="language"
                                width={20}
                    ...
                    <li className="flex items-center my-3 group w-full hover:cursor-pointer">
                        <Link href="/artists" className="flex flex-row items-center w-full">
                            <Image
                                src="/assets/icons/artist_icon.png"
                                alt="artists"
                                width={20}
